...
{
    [TestFixture(Description = "Tests for Opo.Net.Mime.MimeEntityFactory")]
    public class MimeEntityFactoryTests
    {
        ...
        {
            Assert.That(MimeEntityFactory.GetInstance(_mimeParser.Object, TestMimeMessage.mimeData), Is.TypeOf(typeof(MultipartMimeEntity)));
            Assert.That(MimeEntityFactory.GetInstance(_mimeParser.Object, TestMimeMessage.multipartAlternativePart), Is.TypeOf(typeof(MultipartMimeEntity)));
            Assert.That(MimeEntityFactory.GetInstance(_mimeParser.Object, TestMimeMessage.textPart), Is.TypeOf(typeof(TextMimeEntity)));
            Assert.That(MimeEntityFactory.GetInstance(_mimeParser.Object, TestMimeMessage.htmlPart), Is.TypeOf(typeof(TextMimeEntity)));
            Assert.That(MimeEntityFactory.GetInstance(_mimeParser.Object, TestMimeMessage.attachmentPart), Is.TypeOf(typeof(AttachmentMimeEntity)));
        }
    }
}
